...
<tr><td>callback</td><td>a pointer to a function<br/>first parameter is the result<br/>second pqrqmeter is a pointer to the next sibiling of autocomplete</td><td>null</td></tr>
